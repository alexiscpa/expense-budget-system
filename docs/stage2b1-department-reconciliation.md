...
版本：v1.1（v1.0 的 5 筆 NEEDS_CONFIRMATION 已由人工裁決為 PARENT_ONLY，見版本紀錄）
...
| 33 | 12331 | 海外行銷部(無) | S | 是 | PARENT_ONLY（v1.1 人工裁決） | 12301 | — |
| 34 | 12401 | 營業企劃處 | S | 否 | PARENT_ONLY（v1.1 人工裁決） | — | — |
| 35 | 12411 | 成品企劃部 | S | 否 | BUDGET_OWNER | 12401 | — |
| 36 | 12421 | 客戶服務部 | S | 否 | BUDGET_OWNER | 12401 | — |
| 37 | 12501 | 教研營業處 | S | 否 | PARENT_ONLY（v1.1 人工裁決） | — | — |
...
| **合計** | **45** | （PARENT_ONLY 18、MERGED 1、INACTIVE 4、NEEDS_CONFIRMATION 0，共 68；v1.1 更新，見版本紀錄） |

---

## 3　PARENT_ONLY／INACTIVE／MERGED／NEEDS_CONFIRMATION 清單

### 3.1　PARENT_ONLY（18 筆，純上層彙總，不直接輸入）

前 13 筆為 v1.0 原始盤點結果；後 5 筆（標示「v1.1 人工裁決」）原為 §3.4 的 NEEDS_CONFIRMATION，經人工明確確認為上層彙總單位，於 v1.1 改列於此——原始調查證據（出現位置、明細頁、公式）全數保留，未刪除任何部門紀錄。
...
| 12331 | 海外行銷部(無) | **v1.1 人工裁決**：確認為上層彙總單位。原始證據（保留）：ERP部門標「無」且明細頁名含「(x)」停用標記，但該頁仍被 2025 彙總公式實際加總（B表row5「海外行銷企劃」＝1,290,000），與「無」矛盾——人工確認此矛盾的正確解讀是「上層彙總單位」，非獨立編製單位。彙總上層：12301（海外營業處） |
| 12401 | 營業企劃處 | **v1.1 人工裁決**：確認為上層彙總單位。原始證據（保留）：全檔零出現（含歷史帳），但子代碼 12411/12421 是活躍 BUDGET_OWNER；人工確認 12401 本身即為 12411/12421 的彙總層級，比照 12201/12301 的模式 |
| 12501 | 教研營業處 | **v1.1 人工裁決**：確認為上層彙總單位。原始證據（保留）：無 2025 彙總或明細頁，但歷史帳有 3 筆紀錄，非「無」標記 |
